...
### Unexpected Argo CD Diff:

Rollouts v1.0 now vends apiextensions.k8s.io/v1 CustomResourceDefinitions (from apiextensions.k8s.io/v1beta1).
The v1 CRD no longer supports preservation of unknown fields in objects (spec.preserveUnknownFields: false).
In order to support a smooth upgrade 
